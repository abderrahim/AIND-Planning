...
class AirCargoProblem(Problem):
            ...
            for c in self.cargos:
                for p in self.planes:
                    for a in self.airports:
                        ...
                        preconds_pos = [expr('At({}, {})'.format(c, a)),
                                        expr('At({}, {})'.format(p, a)),
                                        expr('Plane({})'.format(p)),
                                        expr('Cargo({})'.format(c)),
            ...
            for c in self.cargos:
                for p in self.planes:
                    for a in self.airports:
                        ...
                        preconds_pos = [expr('In({}, {})'.format(c, p)),
                                        expr('At({}, {})'.format(p, a)),
                                        expr('Plane({})'.format(p)),
                                        expr('Cargo({})'.format(c)),
                                        expr('Airport({})'.format(a))]
    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            if all((fluent not in action.precond_pos) for fluent in fluent_state.neg) \
               and all((fluent not in action.precond_neg) for fluent in fluent_state.pos):
